(function (global) {
  ...
  function render(live, liveIndex) {
    ...
    drawerBody.innerHTML = '<div class="shared-live-drawer-hero">' +
      (live.kv ? '<button class="shared-live-hero-poster-button" type="button" data-live-hero-image><img class="shared-live-hero-poster" src="' + escapeHTML(live.kv) + '" alt="' + escapeHTML(live.name) + '"></button>' : (live.poster ? '<img class="shared-live-hero-poster" src="' + escapeHTML(live.poster) + '" alt="' + escapeHTML(live.name) + '">' : '<div class="shared-live-hero-poster shared-live-hero-unknown"><i></i><strong>' + escapeHTML(live.name) + '</strong><small>UNKNOWN</small></div>')) +
